...
if (isset($_POST["Common"])) {
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
                    ...
                    <div class="product-widget">
						...
						<div class="product-body">
							<h3 class="product-name"><a href="#">'.$product_desc.'</a></h3>
	...
	<tr >
		<td data-th="Product" >
			<div class="row">
				...
				<div class="col-sm-4 "><img src='.$product_image.' style="height: 100px;width:100px;"/>

				</div>
				<div class="col-sm-6">
					<div style="max-width=50px;">
					<br><br><Center><h4 class="nomargin product-name header-cart-item-name"><a href="product.php?p='.$product_id.'">'.$product_title.'</a></h4></center>
	...
	<tfoot>
		...
		<tr>
			<td><a href="store.php" class="btn btn-warning">
			...
			<td>
				...
				class="btn btn-success">Ready to Checkout</a></td>
					</tr>
				</tfoot>
		...
		<input type="hidden" name="item_name_'.$x.'" value="'.$row["product_desc"].'">
		...
		'<input type="hidden" name="return" 
			...
			<input type="submit" id="submit" name="login_user_with_product" 
				name="submit"class="btn btn-success"value="Ready to Checkout">
			</form></td>
